"""
Script de teste para OpenRouter Gemini 2.0 Flash
"""
import asyncio
import sys
import os
...
from app.services.openrouter_gemini_client import get_openrouter_gemini_client
...
async def testar_openrouter():
    ...
    print("\n" + "="*60)
    print("🧪 TESTE: OpenRouter Gemini 2.0 Flash")
    print("="*60)
    
    try:
        # Inicializa cliente
        client = get_openrouter_gemini_client()
        ...
        resultado = await client.executar_prompt_raw(
            "Responda em uma frase: O que é o mercado de ações?",
            task_type="teste"
        )
        ...
        prompt_json = """
Analise a ação PETR4 e retorne um JSON com:
{
    "ticker": "PETR4",
